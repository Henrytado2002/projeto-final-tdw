                    ...
                    <div className='about-info-text'>
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                from the Master's in Communication and Web Technologies, at the <a href='https://www.ua.pt/' target='_blank' >University of Aveiro</a>. This app was
                        ...
                        <section>
                            ...
                            <ul>
                                <li> <a href='https://react.dev/' target='_blank' >ReactJS</a> proficiency</li>
                                <li><a href='https://www.redhat.com/en/topics/devops/what-is-ci-cd' target='_blank' >CI/CD</a> integration</li>
                                <li>Dynamic Deployment of Web Apps</li>
                                <li> <a href='https://redux-toolkit.js.org/' target='_blank' >Redux Tool Kit (RTK)</a> for data storage and manipulation, and for consumption of data originating from external APIs</li>
                            </ul>
                            <p>
                                ...
                                lectured in class, that, in my opinion, complemented the rest of the app nicely, these being the  <a href='https://firebase.google.com/' target='_blank' >Firebase's Authentication and FireStore
                                Database</a> (and their respective APIs, through RTK) to save and manage user authentication and to store the user's information, in relation
